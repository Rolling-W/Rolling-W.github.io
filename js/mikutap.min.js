...
var MainManager = function() {
    ...
    function t() {
        ...
        v ? ($("#scene_loading").stop().css("display", "none"), $("#bt_back").stop().css("display", "none"), p && $("#bt_fs","#foot").stop().css("display", "none"), $("#scene_main .set").stop().css("display", "none")) : $("#scene_main").stop().fadeIn(200, "linear"),
    ...
    p && ($("#bt_fs","#foot").css("display", "block"), $("#bt_fs","#foot").click(function(a) {
    ...
    function() {
        ...
        function r(a, e, n) {
            v != a && (1 != e && (v = a), 0 > v || (T.play(a % T.length, n), L = 90, _ && (_ = !1, $("#bt_back").stop().fadeOut(200, "linear"), p && $("#bt_fs","#foot").stop().fadeOut(200, "linear"), $("#scene_main .set").stop().fadeOut(200, "linear")), 0 >= --F && (e = Math.floor(k.length * Math.random()), n = e + P.length, (e = G[n].length ? G[n].pop() : new k[e](X, n)).play(), F = 12 * Math.random() + 6), e = a % P.length, (e = 0 < G[e].length ? G[e].pop() : new P[e](X, e)).play()))
        }
        function l() {
            var a = Math.random();
    ...
    i(),
    aidn.util.webaudio ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), m && $("#scene_main .attention").html("轻触 &amp; 滑动!"), u || $("#scene_top .attention").text("打开声音，\nEnjoy it!")) : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), u || $("#ng .atten").html("抱歉，</br>你的浏览器不支持此页面")),
